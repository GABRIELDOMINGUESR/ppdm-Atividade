package br.sena.jandira.ppdm.com.example.myapplication
...
import br.sena.jandira.ppdm.com.example.myapplication.ui.theme.PpdmTheme
import br.senai.sp.jandira.sistemadeuploadsaf.util.StorageUtil
...
fun PhotoPicker() {
    ...
    Column(
        ...
        Box(
            ...
            Image(painterResource(id = R.drawable.add_a_photo), contentDescription = "", modifier = Modifier.size(height = 32.dp, width = 32.dp)
            )
        }
        Text(text = "$url")
        Column {
            OutlinedTextField(value = nome ?: "example@gmail.com", shape = RoundedCornerShape(16.dp), onValueChange = { nome = it }, keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text),
                modifier = Modifier
                    .fillMaxWidth()
                    .height(63.dp),
